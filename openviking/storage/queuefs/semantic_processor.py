...
class SemanticProcessor(DequeueHandlerBase):
    ...
    def __init__(self, max_concurrent_llm: int = 32):
        ...
        self._directory_semantic_task = DirectorySemanticTask(self)
                ...
                try:
                    ...
                    try:
                        if msg.context_type != "memory":
                            self._directory_semantic_task.mark_dirty(directory_uri, msg.id)
                            dirty_owned = True
                        if msg.context_type == "memory":
                    ...
                    if dirty_owned:
                        self._directory_semantic_task.discard_dirty(directory_uri, msg.id)
